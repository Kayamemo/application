          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md sticky top-20 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <button onClick={handleContact} className="w-full border-2 border-gray-200 text-gray-700 font-semibold py-2.5 rounded-xl hover:border-primary-300 hover:text-primary-600 transition-all text-sm flex items-center justify-center gap-2">
